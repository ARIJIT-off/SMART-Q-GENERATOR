...
if (!submissionId) { alert('No submission ID found.'); window.location.href = '/student.html'; }
...
function renderResult({ submission, enrichedAnswers, exam }) {
 ...
 Cheating detected: ${submission.cheatingEvents?.join(', ') || 'unknown event'}
 ...
 <div class="answer-q">Q${i+1}. ${a.questionText}
